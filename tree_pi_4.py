# tree pi 4 no sound on startup just flashing trees.
# tree pi 2 adding program runs always and starts on button.
# tree pi 1 adding button and music
...
sndon = pygame.mixer.Sound("/home/pi/Desktop/Sounds/Sounds_On_nr.wav")
sndon.set_volume(0.3)
clang = pygame.mixer.Sound("/home/pi/Desktop/Sounds/double_clang_nl.wav")
...
send_byte_s('0001_0001') #MODE2 b.1:0=01 lets OE* work
...
while z > 0:
    ...
    #        pass
        ...
        sync_error=[]
        for j in range(750): #was 1000
            #wait for the right time
            sync_target=time_old+float(j)*0.04 #originally .03
        ...
        GPIO.output(od ,GPIO.LOW)
        if y == 2:
            print("elapsed time for 750 sets = ",t_del)
            print("max sync error=",max(sync_error))
            print("average sync error=",sum(sync_error)/750) #was 1000 originally
            y = 0
