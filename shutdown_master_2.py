...
# Phase 2:
# - connect the socket right away
# - listen for messages to turn sound on or off
# - send a message to request shutdown
#     - still use the socket being closed as the ack of shutdown complete
